...
void parser(std::ofstream& logs, int error_line, std::string instruction, std::string& opcode, std::string& src_reg1, std::string& src_reg2, std::string& dest_reg, bool& fail, std::vector<std::string>& debug) {
